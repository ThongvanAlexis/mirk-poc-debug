      ...
      try {
        ...
        expect(
          ...
          containsAll(<String>[
            'epochSecond',
            'sampleCount',
            'canvasTxMin', 'canvasTxMedian', 'canvasTxMax',
            'canvasTyMin', 'canvasTyMedian', 'canvasTyMax',
            'pixelOriginXMin', 'pixelOriginXMedian', 'pixelOriginXMax',
            'pixelOriginYMin', 'pixelOriginYMedian', 'pixelOriginYMax',
            'centerLatMin', 'centerLatMedian', 'centerLatMax',
            'centerLonMin', 'centerLonMedian', 'centerLonMax',
            'uOffsetXMin', 'uOffsetXMedian', 'uOffsetXMax',
            'uOffsetYMin', 'uOffsetYMedian', 'uOffsetYMax',
          ]),
        );
