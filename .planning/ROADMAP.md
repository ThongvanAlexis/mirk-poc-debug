...
**Requirements**: FOG-09, FOG-10, FOG-11, FOG-12, FOG-13, FOG-14, FOG-15, FOG-16, FOG-17, FOG-18, PERF-07, PERF-08, UX-01, UX-02, DEBUG-01 (DEBUG-01 + FOG-15 added 2026-05-03 via Plan 03.1-07; FOG-14 refined; FOG-16 + FOG-17 + UX-02 added 2026-05-03 via Plan 03.1-09 Walk #3; FOG-18 added 2026-05-03 via Plan 03.1-11 Walk #4 — world-meter anchor)
**Depends on**: Phase 3
**Plans**: 11 plans landed + Plan 03.1-12 planned 2026-05-XX via /gsd:plan-phase 3.1 --gaps (Walk #4 closed `iterating-with-Q1-Q4-confirmed-Q5-zoom-scramble-open` 2026-05-03; per CONTEXT §Iteration policy no hard cap on walk count — Plan 03.1-12 (world-meter anchor for FOG-18) + Walk #5 pending execution)
  ...
  - [ ] 03.1-12-PLAN.md — Plan 03.1-12 software-fix landing (Fix B world-meter anchor) + Walk #5 (post-fix re-validation): `worldMeters = (fragUv * uResolution + uPixelOrigin) * uMetersPerPixel; noiseUv = worldMeters / kNoiseTilePxMeters` in BOTH `atmospheric_fog.frag` + `atmospheric_fog_debug_spiral.frag`. NEW uniform `uMetersPerPixel` slot 41 → 42 (under shader budget cap of 64). Dart-side `metersPerPixel = 156543.03392 * cos(camera.center.latitude * π/180) / pow(2.0, camera.zoom)` forwarded via uniform. New const `kNoiseTilePxMeters = 1024.0` (1 km cell at the hike scale). Acceptance: behavioural test asserts noise sampling is zoom-invariant at fixed geographic coordinates across z=10..15. Closes FOG-18; if Walk #5 confirms, FOG-04..07 + FOG-11 + FOG-15 flip from Falsified-in-production → Complete — Verified-by-walk and Phase 3.1 closes with HYPOTHESIS CONFIRMED-AFTER-FIX (or strengthens to DENIED-FINAL if even meter-anchor fails empirically). Plan pending — author via `/gsd:plan-phase 3.1 --gaps`.
...
| 03.1. Fix Fog Pan-Translation | 11/12 | In Progress (5th iteration; Walk #4 ITERATING-WITH-Q1-Q4-CONFIRMED-Q5-OPEN; Plan 03.1-12 + Walk #5 pending) |  |
