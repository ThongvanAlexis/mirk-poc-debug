...
**Depends on**: Phase 3
**Plans**: 9 plans landed (Walk #3 closed `iterating-with-partial-progress-and-rotation-regression` 2026-05-03; per CONTEXT §Iteration policy no hard cap on walk count — Plan 03.1-10 pending follow-up)
  ...
  - [ ] 03.1-10-PLAN.md — World-coordinate noise sampling (FOG-17 + FOG-17a precision pairing) + rotation handling (FOG-16 path (a) UX-02 disable rotation — developer-endorsed) — pending `/gsd:plan-phase 3.1 --gaps` invocation
...
| 03.1. Fix Fog Pan-Translation | 9/10 | In Progress (4th iteration; Plan 03.1-10 pending) |  |
